...
<div id="withdrawPage">
	<table style="width: 99%;">
		<tr>
			<td width="20%">
				<span class="sb-content-desc"> Credit Operations: Get Loan </span>
			</td>
		</tr>
	</table>
	<form action="loan" method="POST">
		<table style="width: 600px;">
			...
			<tr>
				<td class="sb-table-button-row" colspan="3" align="right"><input class="sb-button" type="submit" value="Get Loan!" /></td>
			</tr>
			<tr>
